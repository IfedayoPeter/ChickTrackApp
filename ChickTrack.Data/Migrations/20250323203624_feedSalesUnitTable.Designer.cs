...
namespace ChickTrack.Data.Migrations
{
    ...
    [Migration("20250323203624_feedSalesUnitTable")]
    partial class feedSalesUnitTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChickTrack.Domain.Entities.Feed.FeedLog", b =>
                {
                    ...
                    b.Property<int>("AvailableBags")
                        .HasColumnType("int");

                    b.Property<int>("BagsBought")
                        .HasColumnType("int");
